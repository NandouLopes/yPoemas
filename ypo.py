...
try:
    ...
    st.warning(translate('Google Translator não conectado. Traduções não disponíveis no momento.'))


try:
    from gtts import gTTS
except ImportError as ex:
    st.warning(translate('Google TTS não conectado. Leituras não disponíveis no momento.'))
